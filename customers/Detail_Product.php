...
<body>
    ...
    try
    {
        ...
        $req=" SELECT * FROM products WHERE prd_id=$prd_id";
        ...
        foreach($pdostat as $ligne)
        {
            ...
            <div class='row g-0'>
                <div class='col-md-4'>
                <img src='../pictures/".$ligne['prd_img']."'class='img-fluid rounded-start' alt='Image' >
                </div>
                <div class='col-md-8'>
                <div class='card-body'>
                <h5 class='card-title'>". $ligne['prd_title'] . "</h5>
                <hr>   
                <h4>". $ligne['prd_price'] . "</h4> 
                Size : <br>
                <select name='op 'id='version' >Size
                    <option value='0-3mo.' selected>select size</option>
                    <option value='3-6 mo.'>0-3 mo.</option>
